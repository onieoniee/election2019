...
# %%
# plot golput
# df.plot(x='wilayah', y=['penduduk', 'pemilih'])
plt.plot(df['wilayah'],df['penduduk']/10**6, color='pink', label='Jumlah Penduduk', marker='o')
plt.plot(df['wilayah'], df['pemilih']/10**6, color='blue', label='Jumlah Pemilih', marker='o')
plt.title('Statistik Total Penduduk Indonesia dan Total Pemilih dalam Pemilu 2019')
plt.xlabel('Provinsi')
